...
$lswl_site_name   = get_bloginfo( 'name' );
$lswl_product_url = get_permalink( $product->get_id() );
$lswl_has_name    = ! empty( $subscriber->name );
$lswl_first_name  = $lswl_has_name ? explode( ' ', trim( $subscriber->name ) )[0] : '';
?>
...
<p>
	<a href="<?php echo esc_url( $lswl_product_url ); ?>" class="button"><?php esc_html_e( 'Shop Now', 'lime-stock-watchlist' ); ?></a>
</p>
